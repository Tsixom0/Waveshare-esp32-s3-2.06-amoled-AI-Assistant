...
| --------------------- | -------------------------------------------------- | ---------------------------------------------------
| **Display rendering** | Direct drawing to CO5300 AMOLED                    | Optional PSRAM canvas/double-buffer style                                  |                                                    | rendering (no more flickering)                
| **Brightness**        | Software brightness by scaling RGB colors          | Hardware brightness through CO5300 display                                 |                                                    | command, so theme colors stay stable      
